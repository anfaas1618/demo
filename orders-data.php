...
if (isset($_POST['update_order_status'])) {
    ...
    $items=[];
    foreach($res as $row){
            $data=array($row['product_id'],$row['product_variant_id'],$row['pname'],$row['measurement'],$row['mesurement_unit_name'],$row['quantity'],$row['discounted_price'],$row['price'],$row['oi_active_status'],$row['lens_prices'],$row['lens_name'],$row['RSPH'],$row['RCYL'],$row['RAXIS'],$row['RVA'],$row['LSPH'],$row['LCYL'],$row['LAXIS'],$row['LVA'],$row['intermediate'],$row['additional'],$row['imageUrl']);
...
<!--                    <form  id="update_status_form">-->
                        <table class="table table-bordered">
                            ...
                            <tr>
                                <th style="width: 10px">Lens Name</th>
                                <td ><?php echo $res[0]['lens_name']; ?></td>

                            </tr>
                             
                         
                             <tr>
                                <th style="width: 10px">Lens Price (<?=$settings['currency']?>)</th>
                                <td ><?php echo $res[0]['lens_prices']; ?></td>
                            ...
                            <tr>
                              ...
                              <tr>
                                <th style="width: 10px">doctors slip(eye prescription)</th>
                                <td> <a href="<?php echo $res[0]['imageUrl']; ?>" target="_blank">
                                    
  <?php  echo "<img src='",$res[0]['imageUrl'],"' width=200 height=200/>"; ?>
  view full screen
</a>
                                </td>
...
<thead>
  <tr>
    <th class="tg-0pky">New Rx</th>
    <th class="tg-0pky">SPH</th>
    <th class="tg-0pky">CYL</th>
    <th class="tg-0pky">AXIS</th>
    <th class="tg-0pky">V/A</th>
  </tr>
</thead>
<tbody>
  <tr>
    <td class="tg-0pky">R-EYE</td>
    <td class="tg-0pky"><?php echo $res[0]['RSPH']; ?></td>
    <td class="tg-0pky"><?php echo $res[0]['RCYL']; ?></td>
    <td class="tg-0pky"><?php echo $res[0]['RAXIS']; ?></td>
    <td class="tg-0pky"><?php echo $res[0]['RVA']; ?></td>
  </tr>
  <tr>
    <td class="tg-0pky">L-EYE</td>
    <td class="tg-0pky"><?php echo $res[0]['LSPH']; ?></td>
    <td class="tg-0pky"><?php echo $res[0]['LCYL']; ?></td>
    <td class="tg-0pky"><?php echo $res[0]['LAXIS']; ?></td>
    <td class="tg-0pky"><?php echo $res[0]['LVA']; ?></td>
  </tr>
</tbody>
 <tr>
...
<tbody>
  ...
  <tr>
     <th style="width: 10px;padding:10px">Additional</th>
                                <td><?php echo $res[0]['additional']; ?></td> 
  </tr>
                                
                            
                         <tr>
                                <th style="width: 10px">intermediate</th>
                                <td><?php echo $res[0]['intermediate']; ?></td>
                            </tr>
</tbody>
 <tr>
